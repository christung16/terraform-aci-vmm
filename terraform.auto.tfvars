...
web_bd = {
    ...
    subnets = ["192.168.100.254/24", "10.207.40.251/24", "10.207.40.252/24", "10.207.40.253/24", "10.207.40.254/24", "1.1.1.254/24"]
}
app_bd = {
    ...
    display_name = "app_bd"
    vrf_name = "two_tiers_vrf"
    subnets = ["192.168.200.254/24", "192.168.202.254/24"]
}
database_bd = {
